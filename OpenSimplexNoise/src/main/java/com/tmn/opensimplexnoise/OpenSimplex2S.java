...
public class OpenSimplex2S {
     ...
     * for a 2D sandbox style game, where Y is vertical. Probably slightly less optimal for
     * heightmaps or continent maps, unless your map is centered around an equator. It's a slight
    ...
    /**
     * 3D OpenSimplex2S/SuperSimplex noise, with better visual isotropy in (X, Y). Recommended for
     * 3D terrain and time-varied animations. The Z coordinate should always be the "different"
     * coordinate in whatever your use case is. If Y is vertical in world coordinates, call
     * noise3_ImproveXZ(x, z, Y) or use noise3_XZBeforeY. If Z is vertical in world coordinates,
     * call noise3_ImproveXZ(x, y, Z). For a time varied animation, call noise3_ImproveXY(x, y, T).
     */
    ...
    /**
     * 3D OpenSimplex2S/SuperSimplex noise, with better visual isotropy in (X, Z). Recommended for
     * 3D terrain and time-varied animations. The Y coordinate should always be the "different"
     * coordinate in whatever your use case is. If Y is vertical in world coordinates, call
     * noise3_ImproveXZ(x, Y, z). If Z is vertical in world coordinates, call noise3_ImproveXZ(x, Z,
     * y) or use noise3_ImproveXY. For a time varied animation, call noise3_ImproveXZ(x, T, y) or
     * use noise3_ImproveXY.
     */
     ...
     * inspired by DigitalShadow. It was actually faster to narrow down the points in the loop
     * itself, than to build up the index with enough info to isolate 8 points.
     */
     ...
     * freedom. W repeats eventually. Recommended for time-varied animations which texture a 3D
     * object (W=time) in a space where Z is vertical
     */
     ...
     * freedom. W repeats eventually. Recommended for time-varied animations which texture a 3D
     * object (W=time) in a space where Y is vertical
     */
     ...
     * freedom. W repeats eventually. Recommended for time-varied animations which texture a 3D
     * object (W=time) where there isn't a clear distinction between horizontal and vertical
     */
